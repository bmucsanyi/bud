...
from bud.utils.misc import natural_key
...
def extract_tarinfos(
    ...
    # Flatten tartree info into lists of samples and targets w/ targets based on label
    # id via class map arg or from unique paths.
    # NOTE: currently only flattening up to two-levels, filesystem .tars and then one
    # level of sub-tar children this covers my current use cases and keeps things a
    # little easier to test for now.
    tarfiles = []
