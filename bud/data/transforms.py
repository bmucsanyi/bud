...
class Resize:
    def __init__(self, img_size, interpolation):
        ...
        if interpolation == "random":
            ...
            self.interpolation = str_to_interp_mode(mode_str=interpolation)

    def __call__(self, img):
        if isinstance(self.interpolation, tuple):
            interpolation = random.choice(self.interpolation)
        else:
            interpolation = self.interpolation
        return F.resize(img=img, size=self.img_size, interpolation=interpolation)
