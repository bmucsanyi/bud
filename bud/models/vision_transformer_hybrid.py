...
from bud.layers import Format, StdConv2d, StdConv2dSame, nchw_to, to_2tuple
...
from .vision_transformer import VisionTransformer, _create_vision_transformer
...
class HybridEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.proj = nn.Conv2d(
            feature_dim, embed_dim, kernel_size=patch_size, stride=patch_size, bias=bias
        )
