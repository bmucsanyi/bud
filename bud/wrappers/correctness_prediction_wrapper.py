...
from bud.utils import BinaryClassifier
...
class DeepCorrectnessPredictionWrapper(BaseCorrectnessPredictionWrapper):
    """
    This module takes a model as input and creates a correctness prediction module from
    it.
    """
    ...
    def forward_head(self, x, pre_logits: bool = False):
        ...
        binary_logits = self.binary_classifier(binary_classifier_features).squeeze()
...
class CorrectnessPredictionWrapper(BaseCorrectnessPredictionWrapper):
    ...
    def forward_head(self, x, pre_logits: bool = False):
        ...
        binary_classifier_features = features.detach() if self.stopgrad else features
